    ...
    <div class="main--div">
        <div class="paper" >
            ...
            <div class="firstnote2 a">
                ...
                <span style="text-align: center;display: block;font-size: 20px;" >2: A Daypack For Exploration.</span>
                <span style="text-align: center;display: block;font-size: 20px;" >3: Always Stay Flexible</span>
            </div>

            <div class="firstnote3 a">
                <div class="pin"></div>
                <h3 style="text-align: center;font-size: 26px; padding-top: 10px;margin-bottom: 0;" >to be safety</h3>
                <span style="text-align: center; display: block; font-size: 20px;" >1: Don't wear flashy jewelry</span>
                <span style="text-align: center;display: block;font-size: 20px;" >2: Be smart about your money</span>
            ...
            <div class="firstnote4 a">
                <div class="pin"></div>
                <h3 style="text-align: center;font-size: 26px; padding-top: 10px;margin-bottom: 0;" >Places to buy stuff</h3>
                <span style="text-align: center; display: block; font-size: 20px;" >1: Available restaurants</span>
                <span style="text-align: center;display: block;font-size: 20px;" >2: shop</span>
                <span style="text-align: center;display: block;font-size: 20px;" >3: cafe</span>
            </div>
        </div>
        ...
        <div class="location" >
            <iframe styel="border-radius: 20px" width="100%" height="290" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;coord=52.70967533219885, -8.020019531250002&amp;q=1%20Grafton%20Street%2C%20Dublin%2C%20Ireland&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><br />
        </div>
    </div>
